...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = " ʙᴜʏ ᴋʀᴏ :- @KRISx5s_OWNER ❄."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nJOIN BOTH CHANNELS TO GET FREE OR PAID ACCES \n\n @KRISx5shacks AND @KRISx5sfeedbacks \n\n NOW SEND YOUR USER ID TO @KRISx5s_OWNER FOR APPROVAL ")
...
3. MAKE SURE YOU JOINED @KRISx5shacks OTHERWISE NOT WORK
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ᴋʀᴏ :- @KRISx5s_OWNER ❄
'''
    bot.reply_to(message, response)
